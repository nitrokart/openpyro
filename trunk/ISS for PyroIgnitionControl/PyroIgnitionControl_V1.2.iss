...
#define MyAppName "PyroIgnitionControl_V1.2"
...
OutputBaseFilename=PyroIgnitionControl_V1.2
Compression=lzma
...
[Files]
Source: .\PyroIgnitionControl_V1.2\PyroIgnitionControl.exe; DestDir: {app}; Flags: ignoreversion
Source: .\PyroIgnitionControl_V1.2\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
