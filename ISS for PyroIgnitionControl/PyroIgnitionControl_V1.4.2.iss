...
#define MyAppName "PyroIgnitionControl_V.1.4.2"
...
OutputBaseFilename=PyroIgnitionControl_V1.4.2
Compression=lzma
...
[Files]
Source: .\PyroIgnitionControl_V1.4.2\PyroIgnitionControl.exe; DestDir: {app}; Flags: ignoreversion
Source: .\PyroIgnitionControl_V1.4.2\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
