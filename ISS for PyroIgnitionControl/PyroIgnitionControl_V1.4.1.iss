...
#define MyAppName "PyroIgnitionControl_V.1.4.1"
...
OutputBaseFilename=PyroIgnitionControl_V1.4.1
Compression=lzma
...
[Files]
Source: .\PyroIgnitionControl_V1.4.1\PyroIgnitionControl.exe; DestDir: {app}; Flags: ignoreversion
Source: .\PyroIgnitionControl_V1.4.1\*; DestDir: {app}; Flags: ignoreversion recursesubdirs createallsubdirs
